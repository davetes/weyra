// SVG Icon components for the admin panel
...
export function IconDeposit({ size = 20, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconWithdraw({ size = 20, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconBan({ size = 20, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
