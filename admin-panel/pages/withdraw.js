    ...
    return (
      <Card title="No access">
        <div className="text-sm text-muted">
          You do not have permission to view withdraw requests.
        </div>
      </Card>
    );
  }
                ...
                return (
                  ...
                  >
                    ...
                    <td className="pr-3 py-3 font-medium text-slate-200">
                      {r.player?.username || r.player?.phone || "-"}
                    </td>
                    ...
                    <td className="pr-3 py-3 text-muted max-w-[120px] truncate font-mono text-xs">
                      {String(r.account || "").slice(0, 40) || "-"}
                    </td>
                    <td className="pr-3 py-3 text-muted max-w-[120px] truncate">
                      {r.decisionNote
                        ? String(r.decisionNote).slice(0, 60)
                        : "-"}
                    </td>
                    ...
                    <td className="pr-3 py-3 text-muted text-xs whitespace-nowrap">
