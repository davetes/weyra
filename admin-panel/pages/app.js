        ...
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-lg font-semibold text-slate-100">
              Welcome back,{" "}
              <span className="text-accent-light">{admin?.username}</span>
            </h2>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="pr-3 text-slate-300">
                          {t.player?.username || `#${t.playerId}`}
                        </td>
                        <td
                          className={`pr-3 font-medium ${amt >= 0 ? "text-success" : "text-danger"}`}
                        >
                          {amt >= 0 ? "+" : ""}
                          {formatMoney(t.amount)} ETB
                        </td>
                        <td className="pr-3 text-muted max-w-[200px] truncate">
                          {t.note || "-"}
                        </td>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card title="Players">
            <p className="text-sm text-muted mb-3">
              Search, view details, and manage player accounts.
            </p>
            <a
              href="/players"
              className="text-sm text-accent-light hover:text-accent font-medium transition-colors"
            >
              Manage Players →
            </a>
          </Card>
          <Card title="Admin Users">
            <p className="text-sm text-muted mb-3">
              Create admin accounts and manage permissions.
            </p>
            <a
              href="/admins"
              className="text-sm text-accent-light hover:text-accent font-medium transition-colors"
          ...
          <Card title="App Settings">
            <p className="text-sm text-muted mb-3">
              Configure application parameters and values.
            </p>
            <a
              href="/settings"
              className="text-sm text-accent-light hover:text-accent font-medium transition-colors"
